...
test_parse_yaml_valid (CommonMmdTestFixture *fixture, gconstpointer user_data)
{
  ...
  yaml_path =
    g_strdup_printf ("%s/modulemd/v2/tests/test_data/rpm-map/valid.yaml",
                         ...
                         gconstpointer user_data)
{
  ...
  yaml_path = g_strdup_printf (
    "%s/modulemd/v2/tests/test_data/rpm-map/missing-version.yaml",
    g_getenv ("MESON_SOURCE_ROOT"));
  g_assert_nonnull (yaml_path);
                          ...
                          gconstpointer user_data)
{
  ...
  yaml_path =
    g_strdup_printf ("%s/modulemd/v2/tests/test_data/rpm-map/wrong-nevra.yaml",
                     g_getenv ("MESON_SOURCE_ROOT"));
  g_assert_nonnull (yaml_path);
